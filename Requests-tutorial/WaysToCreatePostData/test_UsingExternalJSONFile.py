...
class TestCreateStudentUsingExternalJSONFile:
    @pytest.fixture(autouse=True)
    def setUp_and_tearDown(self):
        self.base_url = "http://localhost:3000/students"
        json_file = open('request_body.json')
        self.student_data = json.load(json_file)
    ...
    def test_addStudentUsingExternalJSONFile(self):
